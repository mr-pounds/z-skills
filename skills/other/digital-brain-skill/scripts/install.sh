...
# Installs Digital Brain as a Agent Code skill
...
echo ""
echo "1) User-wide (recommended) - ~/.Agent/skills/"
echo "2) Current project only   - ./.Agent/skills/"
...
case $choice in
    1)
        TARGET_DIR="$HOME/.Agent/skills/$SKILL_NAME"
        ;;
    2)
...
echo ""
echo "Agent Code will automatically discover the skill."
