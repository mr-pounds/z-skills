...
```
digital-brain/
├── SKILL.md                 # Main skill definition (Agent Code compatible)
...
5. **Platform Agnostic** - Works with Agent Code, Cursor, any AI assistant
