...
# 📊 CSV Data Summarizer - Agent Skill

A powerful Agent Skill that automatically analyzes CSV files and generates comprehensive insights with visualizations. Upload any CSV and get instant, intelligent analysis without being asked what you want!

<div align="center">

[![Version](https://img.shields.io/badge/version-2.1.0-blue.svg)](https://github.com/coffeefuelbump/csv-data-summarizer-Agent-skill)
...
[![Download Skill](https://img.shields.io/badge/Download-CSV%20Data%20Summarizer%20Skill-blue?style=for-the-badge&logo=download)](https://github.com/coffeefuelbump/csv-data-summarizer-Agent-skill/raw/main/csv-data-summarizer.zip)

**2️⃣ Try the Demo Data**  
[![Download Demo CSV](https://img.shields.io/badge/Download-Sample%20P%26L%20Financial%20Data-green?style=for-the-badge&logo=data)](https://github.com/coffeefuelbump/csv-data-summarizer-Agent-skill/raw/main/examples/showcase_financial_pl_data.csv)
...
1. **Upload** any CSV file to Agent.ai
...
1. Download the latest release: [`csv-data-summarizer.zip`](https://github.com/coffeefuelbump/csv-data-summarizer-Agent-skill/releases)
2. Go to [Agent.ai](https://Agent.ai) → Settings → Capabilities → Skills
...
```bash
git clone git@github.com:coffeefuelbump/csv-data-summarizer-Agent-skill.git
cd csv-data-summarizer-Agent-skill
...
Built for the Agent Skills platform by [Anthropic](https://www.anthropic.com/news/skills).
